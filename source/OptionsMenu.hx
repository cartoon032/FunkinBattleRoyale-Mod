...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Gameplay", [
			...
			new BreakTimerOption("How long in sec between note to start showing break timer"),
		...
		new OptionCategory("Performance", [
			...
			new ShowRatingOption("Shows note ratings next to the strumline"),
			new ShowComboOption("Shows your combo next to the strumline"),
			new ShowMSOption("Shows note timings over the strumline"),

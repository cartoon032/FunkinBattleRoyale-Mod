...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>){
		...
		// 		pixelBox = true;
		// 		hasDialog = true;
		// 		FlxG.sound.play(SELoader.loadSound('assets/shared/sounds/ANGRY_TEXT_BOX'));
		...
		swagDialogue.sounds = [FlxG.sound.load(SELoader.loadSound('assets/shared/sounds/pixelText.ogg'), 0.6)];
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			if(swagDialogue.text.length < dialogueList[0].length && !requestedSkip && !FlxG.keys.justPressed.ESCAPE){
				swagDialogue.skip();
				FlxG.sound.play(SELoader.loadSound('assets/shared/sounds/pixelText.ogg'), 0.8);
				...
				if (dialogueList[1] == null && dialogueList[0] != null || FlxG.keys.justPressed.ESCAPE)
				{
					...
					{
						isEnding = true;
						FlxG.sound.play(SELoader.loadSound('assets/shared/sounds/clickText.ogg'), 0.8);
